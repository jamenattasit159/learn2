...
<form action="!insert_successPromo.php" method="GET">
<p>
<label for="ProductID">รหัสโปรโมชั่น  </label>
...
<p>
<label for="ProductDe">รายละเอียด  </label>
<input type="text" name="ProductDe" id="ProductDe" value=""/>
</p>
<p>
    <input type="submit">
</p>
