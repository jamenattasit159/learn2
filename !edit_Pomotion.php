...
$sql="SELECT * FROM Promotion WHERE ProductID  ='$_GET[ProductID]'";
$result=mysqli_query($objConnect ,$sql);
$data = mysqli_fetch_array($result, MYSQLI_BOTH)
?>
<center>
<form method="GET" action="!edit_successPromo.php">
<p>
...
<p>
<label for="ProductDe">ตะกร้าสินค้าที่จะแก้ไข</label>
<input type="text" name="ProductDe" id="ProductDe" value="<?=$data['ProductDe'];?>" />
</p>
