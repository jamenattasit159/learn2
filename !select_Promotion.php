...
echo "<center>"."<span class='badge bg-primary'>connection Complete</span>" ."<br>"."<br>"/*"connection Complete<br><br>"*/;
$sql = "SELECT  ProductID, ProductName, ProductDe FROM Promotion";
$result = $conn->query($sql);
if ($result->num_rows > 0){
    while($row = $result->fetch_assoc()){
    echo "<center>"."<div class='card border-primary mb-3' style='max-width: 20rem;'>"."รหัสลูกค้า : "."<a href='!edit_Pomotion.php?ProductID=$row[ProductID]'>".$row["ProductID"]."</a>"."<br>"
        ."ชื่อโปรโมชั่น : ".$row["ProductName"]."<br>"
        ."รายละเอียด : ".$row["ProductDe"]."<br>"."</center>"  ;      
    }
}
    else {
        echo "0 results";
    }
    echo "<center>"."<a class = 'card text-white bg-primary mb-3:center'style='max-width: 15rem' href='!insert_Promotion.php'>Add New Invoice</a>"."</center>";
    $conn->close();
?>
</html>