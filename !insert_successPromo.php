...
$sql_insert ="INSERT INTO Promotion(ProductID, ProductName, ProductDe) 
VALUES ('$_GET[ProductID]','$_GET[ProductName]','$_GET[ProductDe]')";
...
echo "<br>";
echo "<a href='!select_Promotion.php'>"."กลับหน้าหลัก"."</a>";
} else {
