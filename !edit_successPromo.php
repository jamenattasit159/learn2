...
$sql_update="UPDATE Promotion SET ProductID ='$_GET[ProductID]',ProductName='$_GET[ProductName]',ProductDe='$_GET[ProductDe]'
...
echo "<br>";
echo "<a href='!select_Promotion.php'>กลับสู่หน้าหลัก</a>";
}
?>
</html>